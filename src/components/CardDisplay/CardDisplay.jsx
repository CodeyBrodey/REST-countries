        ...
        <>
            <div className='CardDisplay-container'>
                <div className={ darkModeActive ? 'search-bar--dark' : "search-bar" }>
                    ...
                    <input className={ darkModeActive ? 'search-bar__input--dark' : 'search-bar__input' } type="text" placeholder='Search for a country...' onKeyDown={ handleSearchInput } />
                </div>
            ...
            <div className='country-cards'>
                {countryCards.filter((value) => {
                    if(value.name.common.toLowerCase().includes(searchQuery) && value.region === filterOptionStatus)return value
                    if(value.name.common.toLowerCase().includes(searchQuery) && filterOptionStatus === null) return value
